...
do
    ...
    do
        ...
        --output_dir=./domainbed/PACS_Output/ERM_ViT_self_dist_DeiT/sweep_RB_loss_${lambda1}_KL_Div_Temperature_${lambda2} --command_launcher multi_gpu --algorithms ERM_ViT_self_dist_DeiT  \
